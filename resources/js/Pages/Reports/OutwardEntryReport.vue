<template>
    <Head :title="'Manage Product'"/>
     <div class="container-fluid p-0">
        <div class="mb-3">
            <h1 class="h3 d-inline align-middle">Outward Entry Report</h1>
        </div>
                <!-- <div class="row">
                        ...
                        >
                          <span v-if="slotProps.column.field==='actions'">
                            <div class="d-flex">
                               ...
                               <a type="button" class="btn btn-primary me-2" target="_blank" :href="'/report/outward-entry-items?id=' +slotProps.row.id">
