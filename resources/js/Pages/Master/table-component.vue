      ...
      <thead>
        <tr>
          ...
          <span>
            ...
            {{ String(column.label) }}
			<vue-feather :type="sortArrow(key)" 
			:size="12"
	...
	computed: {
		...
		table_rows() {
			if (this.sortByApi) {
			    ...
			    var table_rows = this.sorted_rows.length === this.rows.length ? this.sorted_rows : this.rows;
			}
...
.vue-good-table .table  tbody tr td:last-child {
...
.vue-good-table .stripped tbody tr:nth-child(odd) {
